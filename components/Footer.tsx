...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="fixed bottom-0 left-0 w-full bg-slate-50/80 backdrop-blur-sm shadow-lg z-20 border-t border-slate-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8 py-3">
        <div className="flex flex-col sm:flex-row justify-center items-center text-center sm:text-left">
          <p className="text-sm text-slate-500 sm:mr-4 mb-2 sm:mb-0">
          ...
          <a
            ...
            className="px-4 py-2 bg-sky-600 text-white font-semibold rounded-lg shadow-md hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-slate-50 focus:ring-sky-500 transition-all duration-200"
          >
            Get Custom Insights
          </a>
        </div>
